...
-- Loan Performance and Risk: Key Insights

-- Loan performance varies across different loan types and customer segments.
-- Loan status analysis helps identify active, completed, and potentially risky loans.
-- Higher loan exposure requires effective monitoring of repayment performance.
-- Loan analysis can help the bank improve lending decisions and manage credit risk.