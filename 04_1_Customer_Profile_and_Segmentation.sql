...
-- 4 .How many customers are currently active and inactive?
...
-- Customer Profile and Segment Analysis: Key Insights

-- Customer segments show differences in account balances and overall financial value.
-- High-value customer segments contribute significantly to the bank’s deposit base.
-- Customer age, tenure, and segment information help identify different customer profiles and banking needs.
-- The bank can use customer segmentation to provide targeted products, services, and retention strategies.